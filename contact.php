        ...
        <div class="container">
            <div class="row">
                <div class="contact-info col-md-6">
                    <h2 style="color: #0d8654" class="fs-3 text-uppercase mb-4">Contact information</h2>
                    <div class="page-content">
                        <div class="col-md-6">
                            <div class="content-box my-5">
                                <h5 style="color: #0d8654" class="element-title text-uppercase fs-6 fw-bold ">Head Office</h5>
                                <div class="contact-address">
                                    <p style="color: black;">Brgy. Bagongpook
                                        Lipa Batangas Philippines</p>
                                </div>
                                <div class="contact-number ">
                                    <a style="color: black;" href="#">0912 345 6789</a>
                                </div>
                                <div class="email-address">
                                    <p>
                                        <a style="color: black;" href="#">bcas_2000@yahoo.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="inquiry-item col-md-6">
                    <h2 style="color: #0d8654;" class="fs-3 text-uppercase mb-4">Got any questions?</h2>
                    ...
                    <form id="form" class="form-group flex-wrap">
                        ...
                        <div class="d-grid">
                            <button style="background-color: #0d8654; border: none;" class="btn btn-primary btn-lg text-uppercase btn-rounded-none">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <section class="google-map">
        <div class="mapouter">
            <div class="gmap_canvas">
                <iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Batangas%20College%20of%20Arts%20and%20Sciences&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
