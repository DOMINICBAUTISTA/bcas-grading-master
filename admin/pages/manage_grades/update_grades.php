...
<body class="theme-red">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a id="app-title" style="display:flex;align-items:center" class="navbar-brand" href="../dashboard.php">
                    <img id="bcas-logo" style="width:50px;display:inline;margin-right:10px;" src="../https://bcas-oasis.com/images/bcas%20logo%20white.png" />
                </a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="../https://bcas-oasis.com/images/bcas%20logo%20white.png" width="48" height="48" alt="User" />
