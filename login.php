...
<head>
    ...
    <link rel="shortcut icon" href="https://bcas-oasis.com/images/bcas%20logo%20white.png" />
    <!-- Bootstrap -->
...
<body id="sign-in">
    ...
    <div class="preloader">
        <div class="loader_img"><img src="https://bcas-oasis.com/images/bcas%20logo%20black.png" alt="loading..." height="64" width="64"></div>
    </div>
                    ...
                    <div class="row my-form-row">
                        <div class="col-md-6 my-col">
                            <div class="logo-container">
                                <img class="img-logo" src="https://www.bcas.edu.ph/banner2.png">
                            </div>
                        </div>
                        <div class="col-md-6 my-col">
